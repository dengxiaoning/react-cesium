...
module.exports = {
  name: 'react-cesium',  // 项目的名字
  favicon: 'https://github.com/dengxiaoning/cesium_dev_kit/favicon.ico', 
  footer: '<a target="_blank" href="https://github.com/dengxiaoning/cesium_dev_kit">cesium_dev_kit</a>版权所有 © 2024-2099', 
  ...
  api: {  // 对后端请求的相关配置
    host: 'https://benpaodehenji.com/reactCesium',  // 调用ajax接口的地址, 默认值空, 如果是跨域的, 服务端要支持CORS
    path: '',  // ajax请求的路径
