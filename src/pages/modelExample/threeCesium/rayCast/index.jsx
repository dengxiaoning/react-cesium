...
class ThreeCesium extends React.PureComponent {
  initMap () {
    const { viewer, threeJs, base } = new initCesium({
      cesiumGlobal: Cesium,
      threeGlobal: THREE,
      containerId: 'rayCastCesiumContainer',
      threeContainerId: 'rayCastThreeContainer',
      viewerConfig: {
  ...
  componentDidMount() {
    ...
    document.addEventListener("mousemove", function (event) {
      ...
      mouse.y = -(event.clientY / (window.innerHeight+22)) * 2 + 1; // -1~1
    });
  }
  ...
  render() {
    return (
      <div className="raycast-content-main">
      <div id="rayCastCesiumContainer" className="rayCastCesiumContainer"></div>
      <div id="rayCastThreeContainer" className="rayCastThreeContainer"></div>
    </div>
    )
  }
}
